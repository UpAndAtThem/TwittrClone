...
const TweetModal = (props: { isUser: boolean, postId: string, top: string, left: string, styles: any, handleShow: any }) => {
  let modalPos = { position: 'absolute', top: props.top, left: props.left };
  ...
  let modalContent = props.isUser ?
    (
      <>
        ...
        <div>
          <svg viewBox="0 0 24 24" className=""><g><path d="M8.18 16.99c-.19.154-.476.032-.504-.21-.137-1.214-.234-4.053 1.483-5.943.908-1 3.02-1.52 4.475-.198s1.14 3.473.23 4.473c-2.07 2.15-3.428.058-5.686 1.878z"></path></g></svg>
          <p>Edit</p>
        </div>
        <div>
  ...
  return (
    ...
    <Backdrop handleShow={props.handleShow}>
      <div className={styles.TweetEditModal} style={{position: 'absolute', top: modalPos.top, left: modalPos.left}}>
        {modalContent}
      </div>
    </Backdrop>
  );
