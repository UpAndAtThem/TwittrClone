...
const TweetModal = (props: { isUser: boolean, editTweet: any, postId: string, top: string, left: string, styles: any, handleShow: any, modalConfig?: any }) => {
  ...
  let modalContent = props.isUser ?
    (
      <>
        ...
        <div onClick={
          () => {
            props.modalConfig.setEditClicked(!props.modalConfig.editClicked);
            props.editTweet(props.postId)
          }
        }>
